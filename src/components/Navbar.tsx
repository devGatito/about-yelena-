      ...
      <div className="container-shell">
        <div className="flex items-center justify-between gap-4 py-4">
          <div className="hidden md:flex items-center">
            <div className="flex items-center gap-1 rounded-full border border-line bg-white p-2">
              {navItems.map((item) => (
                <motion.div
                  key={item.label}
          ...
          <div className="hidden md:flex items-center gap-3">
            <Button to="/proyecto" variant="secondary">
              {content.actions.viewProject}
            </Button>
            <Button to="/mapa-sitio" variant="primary">
          ...
          <button
            ...
            aria-label={
              isMobileMenuOpen
                ? content.aria.closeMenu
                : content.aria.openMenu
            }
